function save() {
    ...
    <div class="container">
           ...
           <button class="bx bxs-copy-alt" onclick="navigator.clipboard.writeText(localStorage.getItem('code')); swal('Copied!', 'Code is copied to your clipboard.', 'success')">Copy Code</button>
