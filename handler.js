function save() {
    ...
    <div class="container">
           ...
           <p style="color: rgb(0, 195, 255)">Created on: ${Date().replace('GMT+0530 (India Standard Time)','')}</p>
            <button onclick="localStorage.getItem('code').select();localStorage.getItem('code').setSelectionRange(0,99999);navigator.clipboard.writeText(localStorage.getItem('code'));swal('Copied!','Code is copied to your clipboard.','success')">Copy Code</button>
